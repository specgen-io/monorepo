...
import test_client.errors.models.BadRequestError;
import test_client.errors.models.ConflictMessage;
import test_client.errors.models.ErrorLocation;
...
public class CheckClientTest {
	...
	@Test
	public void checkForbidden_throwException() {
