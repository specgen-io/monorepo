...
public open class ClientKotlinOkHttpConfig @Inject constructor(project: Project) {
    @OutputDirectory
...
public open class SpecgenClientKotlinOkHttpTask public constructor() : SpecgenBaseTask() {
    @TaskAction
    public fun execute() {
        val extension = project.extensions.findByType<SpecgenPluginExtension>()
        // TODO: Check if there are nulls below
        val config = extension!!.configClientKotlinOkHttp!!
