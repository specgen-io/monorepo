...
func (w *SpecWalker) OnBinaryRequest(callback func(body *RequestBody)) *SpecWalker {
	w.onBinaryRequest = callback
	return w
}
...
func (w *SpecWalker) BinaryRequest(body *RequestBody) {
	if w.onBinaryRequest != nil {
		w.onBinaryRequest(body)
	}
}
