//go:generate specgen-golang service-go --spec-file ./../spec.yaml --module-name test-service --generate-path ./spec --services-path ./services --swagger-path docs/swagger.yaml
