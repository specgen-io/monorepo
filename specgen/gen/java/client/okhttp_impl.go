...
import (
	...
	"github.com/specgen-io/specgen/specgen/v2/gen/java/imports"
	"github.com/specgen-io/specgen/specgen/v2/gen/java/packages"
	"github.com/specgen-io/specgen/specgen/v2/gen/java/responses"
	"github.com/specgen-io/specgen/specgen/v2/gen/java/writer"
...
func (g *Generator) client(api *spec.Api, apiPackage packages.Module, modelsVersionPackage packages.Module, jsonPackage packages.Module, utilsPackage packages.Module, mainPackage packages.Module) []generator.CodeFile {
	files := []generator.CodeFile{}
